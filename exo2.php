...
if(!empty($_POST))
{
	...
	elseif($mike[0] !="Mike")
		...
		elseif(!is_int(intval($mike[1])) ||  !is_int(intval($mike[2])))                   
		// intval() convertie les éléments en entier soit en integer
		// is_int() vérifie si on a bien un integer
		{
			echo " Votre paramètres n'ai pas un entier";
		}
