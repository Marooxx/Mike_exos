...
$(function() {
    ...
    $.ajax({
        ...
        .done(function(data) {
            ...
            $(".details").eq(0).text(data[0].body.substring(0, 20) + " ...");
            $(".details").eq(1).text(data[1].body.substring(0, 20) + " ...");
            $(".details").eq(2).text(data[2].body.substring(0, 20) + " ...");
            $(".details").eq(3).text(data[3].body.substring(0, 20) + " ...");
            dataJson = data;
        })
